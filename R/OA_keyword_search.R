...
# Set openalexR.mailto option 
#https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool
your_email <- "xxx@gmail.com" # complete with your email
...
# Remove breaks (requirement for openalexR)
...
# Full search string (Useful to copy and paste in the website for double-checking results)
cat(st) 
...
oa_result = openalexR::oa_fetch(
  ...
  count_only = TRUE, # gets only the counts of hits to create oa_summary
  verbose = TRUE
)
...
# Add OA link based on web search using cat(st)
#penguins
...
#furseals
#oa_summary$oa = 'https://openalex.org/works?search.title_and_abstract=(%22Antarctic+fur+seals%22+OR+%22Arctocephalus+gazella%22+OR+%22gazella%22)+AND+(%22Antarctic+Peninsula%22+OR+%22South+Shetland+Islands%22+OR+%22South+Shetland%22+OR+%22South+Orkney+Island%22+OR+%22Brandsfield+strait%22+OR+%22Gerlache+Strait%22+OR+%22Marguerite+Bay%22+OR+%22Antarctic+Sound%22+OR+%22CEMP+site%22+OR+%22domain+1%22+OR+%22subarea+48.1%22+OR+%22subarea+48.2%22+OR+%22subarea+88.3%22+OR+%22area+48%22+OR+%2248.1%22+OR+%2248.2%22+OR+%2288.3%22+OR+%22King+George+Island%22+OR+%22Nelson+Island%22+OR+%22Deception+Island%22+OR+%22Seymour+Island%22+OR+%22Elephant+island%22+OR+%22D1MPA%22+OR+%22scotia+arc%22)+AND+(%22monitoring%22+OR+%22monitor%22+OR+%22monitored%22+OR+%22survey%22+OR+%22surveyed%22+OR+%22inventory%22+OR+%22study%22+OR+%22census%22+OR+%22time-series%22+OR+%22time+series%22+OR+%22data+collection%22+OR+%22long+term%22+OR+%22Abundance%22+OR+%22densities%22+OR+%22density%22+OR+%22season%22+OR+%22seasonal%22+OR+%22seasonality%22+OR+%22years%22+OR+%22decadal%22+OR+%22decade%22+OR+%22interannual%22+OR+%22inter-annual%22+OR+%22trend%22+OR+%22change%22+OR+%22Distribution%22+OR+%22population%22+OR+%22Sighting+Surveys%22+OR+%22Photo+identification%22+OR+%22photo+ID%22+OR+%22drone+survey%22+OR+%22aerial+surveys%22+OR+%22Telemetry%22+OR+%22Passive+acoustic+monitoring%22+OR+%22autonomous+camera%22+OR+%22tagging%22+OR+%22tag%22+OR+%22tagged%22+OR+%22data+logger%22+OR+%22haul+out%22+OR+%22pup+counts%22)&page=1&sort=relevance_score:desc'
#fishes
#oa_summary$oa = 'https://openalex.org/works?page=1&search.title_and_abstract=(%22nototenioideos%22+OR+%22Notothenia+coriiceps%22+OR+%22Notothenia+rossii%22+OR+%22Gobionotothen+gibberifrons%22+OR+%22Nototheniidae%22+OR+%22Notothenioidei%22+OR+%22notothenids%22+OR+%22notothenioids%22+OR+%22Electrona+antarctica%22+OR+%22Pleuragramma+antarcticum%22+OR+%22Trematomus+newnesi%22+OR+%22Dissostichus+mawsoni%22+OR+%22Champsocephalus+gunnari%22+OR+%22Chaenocephalus+aceratus%22+OR+%22Dissostichus+mawsoni%22)+AND+(%22Antarctic+Peninsula%22+OR+%22South+Shetland+Islands%22+OR+%22South+Shetland%22+OR+%22South+Orkney+Island%22+OR+%22Brandsfield+strait%22+OR+%22Gerlache+Strait%22+OR+%22Marguerite+Bay%22+OR+%22Antarctic+Sound%22+OR+%22CEMP+site%22+OR+%22domain+1%22+OR+%22subarea+48.1%22+OR+%22subarea+48.2%22+OR+%22subarea+88.3%22+OR+%22area+48%22+OR+%2248.1%22+OR+%2248.2%22+OR+%2288.3%22+OR+%22King+George+Island%22+OR+%22Nelson+Island%22+OR+%22Deception+Island%22+OR+%22Seymour+Island%22+OR+%22Elephant+island%22+OR+%22D1MPA%22+OR+%22scotia+arc%22)+AND+(%22monitoring%22+OR+%22monitor%22+OR+%22monitored%22+OR+%22survey%22+OR+%22surveyed%22+OR+%22inventory%22+OR+%22study%22+OR+%22time-series%22+OR+%22time+series%22+OR+%22data+collection%22+OR+%22long+term%22+OR+%22Abundance%22+OR+%22densities%22+OR+%22density%22+OR+%22season%22+OR+%22seasonal%22+OR+%22seasonality%22+OR+%22years%22+OR+%22decadal%22+OR+%22decade%22+OR+%22interannual%22+OR+%22inter-annual%22+OR+%22trend%22+OR+%22change%22+OR+%22Distribution%22+OR+%22post-fishery+recovery%22+OR+%22population+recovery%22+OR+%22stock+recovery%22+OR+%22bycatch%22+OR+%22coastal%22+OR+%22demersal%22+OR+%22pelagic%22+OR+%22size+structure%22+OR+%22assemblage%22+OR+%22overexploited%22+OR+%22stock%22+OR+%22fisheries%22+OR+%22nearshore%22+OR+%22inshore%22+OR+%22fjord%22)&sort=relevance_score:desc'
...
# Export the file
saveWorkbook(OUT, paste0("../output/", group, "/", iteration, "/oa_summary.xlsx"),overwrite = TRUE)

### Get data from OpenAlex----
search_outputs <- oa_fetch(
  entity = "works", #oa_entities()
  title_and_abstract.search = st,
  count_only = FALSE, # gets the data not only the counts as before
  verbose = TRUE,
  mailto = oa_email())

# save output
write_csv(search_outputs, paste0("../output/", group, "/", iteration, "/oa_search_results.csv"))

# Clean results
names(search_outputs)
search_outputs_clean = search_outputs %>% 
  # remove GBIF downloads 
  filter(source_display_name != 'Global Biodiversity Information Facility' & display_name != 'Occurrence Download') %>% 
  # authorship
  ...
  dplyr::select("title","abstract",
                ...
                "type","oa_url","author",
                "keyword","concept",
                #"topic","subfield", ### removed because they were not very informative
                "pdf_url",
                "cited_by_count") %>% 
  # add id col
...
# save output
write.csv(search_outputs_clean, paste0("../output/",group, "/", iteration, "/oa_search_results_clean.csv"), row.names = FALSE)

# Remove first iteration because they are already reviewed
iter1 = read_csv(paste0("../output/",group, "/iter_1/oa_search_clean.csv"))
to_keep = search_outputs_clean %>% 
  anti_join(iter1, by = 'title')
write.csv(to_keep, paste0("../output/",group, "/", iteration, "/oa_search_results_clean_noduplicates.csv"), row.names = FALSE)


### Validation----
## DO NOT RUN, SPECIFIC FOR PENGUIN DATA because of additional dataset
# 
